...
<div className='about_me_container'>
    ...
    <div className='about_me textbody_container'>
        <h2 className="darktitlestyle" style={{fontSize: "18pt", marginBottom: "5%", animationDelay: "1.2s"}}>Hello!</h2>
        <h3 className="darkbodystyle">

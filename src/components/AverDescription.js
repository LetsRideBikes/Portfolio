...
<div className='project_description_box'>
  ...
  <h2 className="subtitlestyle">PRODUCT MANAGER | PRODUCT DESIGNER</h2>
   ...
   <h3 className="bodystyle">Averhealth is a toxicology laboratory with specimen collection centers nationwide. Many of these collection centers see very little volume in a day, 

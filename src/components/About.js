...
<div className='about_me_container'>
    <div className='about_me textbody_container'>
        ...
        healthcare companies for over ten years to solve unique problems and bring vision to life.  
        <br/><br/> 
        I'm currently working on software product design and management as a Solutions Architect, though as a natural jack-of-all-trades, I've worn many different hats since my career began. A persistent drive to learn new things has put me at the 
        helm of some of the most fascinating and strategic projects and initiatives- From designing robotics workflows, to building state-of-the-art laboratory 
        facilities, to developing innovative healthcare software. Doing so has allowed me to develop a keen sense of 
        business interdependencies and the literacy to navigate them, as well as a method to successfully and consistently plot
        paths to success. 
        <br/><br/> 
...
</div><div className="about_me_photo"style={{ backgroundImage: `url(${photo})`}}></div>

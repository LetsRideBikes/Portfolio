...
<div className='testimonial-entry'>
    ...
    <div className='testimonial-text'>
        <h3 className='titlestyle'>JOEY SPAGHETTI</h3><h3 className="subtitlestyle modified2" style={{fontSize: "10pt"}}>CEO, Entertainment 720</h3></div>
    ...
    <div className='testimonial-text2'>
        <h3 className='titlestyle'>LAURA BINGO</h3><h3 className="subtitlestyle modified2" style={{fontSize: "10pt"}}>Director of Telekenisis, Heroes Inc.</h3></div>
    ...
    <img className='testimonial-photo' src={bird}></img>
    <div className='testimonial-text'>
        <h3 className='titlestyle'>EARL RUGGS</h3><h3 className="subtitlestyle modified2" style={{fontSize: "10pt"}}>Founder, Ruggs Rugs</h3></div>
    ...
    <img className='testimonial-photo2' src={bird}></img>
    <div className='testimonial-text2'>
        <h3 className='titlestyle'>PAUL PIERCE</h3><h3 className="subtitlestyle modified2" style={{fontSize: "10pt"}}>Small Forward, Boston Celtics</h3></div>
